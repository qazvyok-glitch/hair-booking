            ...
            <div style={{ display: "flex", gap: 12, alignItems: "flex-start" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 8, fontSize: 11, flexWrap: "wrap" }}>
                  ...
                  {(d as any).brand_fee_rate > 0 && (
                    <span style={{ background: "#FAEEDA", color: "#BA7517", padding: "2px 8px", borderRadius: 6 }}>
                      品牌費 {Math.round(((d as any).brand_fee_rate || 0) * 100)}%
                    </span>
                  )}
                </div>
                <div style={{ display: "flex", gap: 4, marginTop: 4, fontSize: 11, color: "#888780" }}>
          ...
          <div style={{ width: "100%", maxWidth: 480, background: "#fff", borderRadius: "20px 20px 0 0", padding: "20px 16px 32px", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <div style={{ background: "#F1EFE8", borderRadius: 10, padding: 12, marginBottom: 12 }}>
              ...
              <div style={{ background: "#EEEDFE", borderRadius: 8, padding: "8px 12px", fontSize: 11, color: "#534AB7" }}>
                預覽：業績 $100,000 → 抽成 ${Math.round(Math.max(0, 100000 - form.commission_base_deduction) * form.commission_rate).toLocaleString()}
              </div>
            </div>

            <div style={{ fontSize: 12, fontWeight: 600, color: "#888780", marginBottom: 8 }}>品牌社群資源共享費</div>
            <div style={{ background: "#F1EFE8", borderRadius: 10, padding: 12, marginBottom: 12 }}>
              <div style={{ fontSize: 11, color: "#888780", marginBottom: 8 }}>計算方式：總服務業績 x %，從抽成中扣除</div>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <div style={{ fontSize: 12, fontWeight: 600, color: "#888780", marginBottom: 8 }}>權限設定</div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 12px", background: "#F1EFE8", borderRadius: 10, marginBottom: 10 }}>
              ...
              <div onClick={() => setForm({ ...form, can_view_members: !form.can_view_members })} style={{ width: 44, height: 24, borderRadius: 12, background: form.can_view_members ? "#534AB7" : "#D3D1C7", cursor: "pointer", position: "relative" }}>
